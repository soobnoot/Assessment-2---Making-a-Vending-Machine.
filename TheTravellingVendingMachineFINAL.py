...
def TheTravellingMerchant():
    ...
    while True:
        while Phase == 1: #This is the 1st phase. The user is asked to choose among the displayed categories.
            ShowCategories()
            try:
                ChosenCategory=int(input("Please choose something from our given categories (Please type a number from 1 - 4): "))
        ...
        while Phase == 2: #This is the 2nd phase. It's the same process as the 1st but the user selects an item instead.
            ShowItems(Category)
            try:
                ItemNumber=str(input(f"Please choose an item (Please type in a code that's displayed from {ChosenCategory}A - {ChosenCategory}E): ").upper())
        ...
        while Phase == 3: #This is the 3rd and final phase. It is the checkout/refund phase, by far the most complicated of the three.
            try:
                UsersItems(TotalGold)
                UserConfirmation = input("Would you like to buy another item (Y/N) or would you like to take an item off your cart? (Q): ").upper()
                if UserConfirmation == "N": #If the user enters 'N', they'll be asked to pay.
                ...
                elif UserConfirmation == "Q": #If the user enters 'Q', they'll be asked to remove something.
                    if len(TotalItems) == 0: #Happens if there isn't anything in the users cart.
                        ...
                        continue
                    try:
                        Remove=int(input("\nPlease select an item to remove from your cart: "))
                        ...
                        UsersItems(TotalGold) #Displays the updated cart.
                    except: #Triggers if the user enters something unrelated to their cart.
                        print("Hey! That isn't in your cart!\n")
                
                elif UserConfirmation == "Y": #Resets the whole process again, back to Phase 1.
                    Phase = 1
